feature 'Viewing listings' do
  scenario 'A user can see listings' do
    ...
    Listing.create(user_id: user.id, name: "Peter Stevens", description: "Romantic get-away", price: 700, date_created: "2020/03/24", dates_available: "2020/03/31")
    Listing.create(user_id: user.id, name: "Peter Stevens", description: "Seaside cottage", price: 700, date_created: "2020/03/24", dates_available: "2020/03/31")
    Listing.create(user_id: user.id, name: "Peter Stevens", description: "Pandemic and chill", price: 700, date_created: "2020/03/24", dates_available: "2020/03/31")
    visit('/listings')
